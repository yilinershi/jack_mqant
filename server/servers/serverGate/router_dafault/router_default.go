...
type Option func(*RouterDefault)

type RouterDefault struct {
	module      module.RPCModule
}

func NewRouterDefault(module module.RPCModule, opts ...Option) *RouterDefault {
	route := &RouterDefault{
		module:      module,
	}
	if opts != nil {
...
//OnRoute 默认路由方法
func (this *RouterDefault) OnRoute(session gate.Session, topic string, msg []byte) (bool, interface{}, error) {
